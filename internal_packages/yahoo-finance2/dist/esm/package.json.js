export default {
  ...
  "//engines//UNCOMMENT_WHEN_WE_DROP_CJS_SUPPORT": {
    node: ">=12.17.0",
    "//node2":
      "we need 14.x for dynamic imports -- JUST FOR FETCH_DEVEL()!  think about this.",
    node2: ">=14.0.0",
  },
  bin: {
  ...
  scripts: {
    ...
    "//schema":
      "ts-json-schema-generator -f tsconfig.json -p 'src/{modules/**/*.ts,lib/options.ts}' -t '*' | node bin/schema-tweak.js > schema.json",
    ...
    "build:cjs":
      'tsc --module commonjs --target es2015 --outDir dist/cjs && sed \'s/"type": "module",/"type:": "commonjs",/\' dist/cjs/package.json > dist/cjs/package-changed.json && mv dist/cjs/package-changed.json dist/cjs/package.json',
