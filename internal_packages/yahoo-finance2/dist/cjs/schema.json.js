module.exports = {
  ...
  $comment:
    "DO NOT EDIT THIS FILE.  It is generated automatically from typescript interfaces in the project.  To update, run `yarn schema`.",
  definitions: {
    YahooFinanceOptions: {
      type: "object",
      properties: {
    ...
    InsightsCompanySnapshot: {
      ...
      required: ["sectorInfo", "company", "sector"],
    },
    InsightsEvent: {
      type: "object",
      properties: {
    ...
    Type: {
      type: "string",
      enum: ["10-K", "10-Q", "8-K", "8-K/A", "10-K/A", "10-Q/A"],
    },
    SummaryDetail: {
      type: "object",
      properties: {
