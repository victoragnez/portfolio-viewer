...
const logObj =
  ...
  ((_a = process === null || process === void 0 ? void 0 : process.stdout) ===
    null || _a === void 0
    ? void 0
    : _a.isTTY)
      ...
      validator.errors = validator.errors.filter((error) => {
        ...
        if (error.schemaPath.startsWith("#/definitions/Quote")) {
          ...
          if (
            ...
            ((_a = error.data) === null || _a === void 0
              ? void 0
              : _a.quoteType) !== schemaQuoteType
          )
            return false;
          /*
          ...
          if (
            ...
            ((_b = error.params) === null || _b === void 0
              ? void 0
              : _b.allowedValue) === schemaQuoteType
          )
            return false;
        }
        return true;
...
`);
    ...
    throw new errors_js_1.FailedYahooValidationError(
    ...
    throw new errors_js_1.InvalidOptionsError(
